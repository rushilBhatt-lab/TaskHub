			...
			{isEditing && (
				<form ref={formRef} action={handleSubmit} className="flex-1 px-[2px]">
					...
					<FormInput
						...
						defaultValue={title}
						className="text-sm px-[7px] py-1 h-7 font-medium border-transparent hover:border-input focus:border-input trasnition truncate bg-transparent focus:bg-white"
					/>
